...
CREATE TABLE `idea_event` (
  ...
  `detailedDescription` varchar(2550) DEFAULT NULL,
...
CREATE TABLE `idea_team` (
  ...
  `teammateNumber` int(11) DEFAULT NULL,
  `maxTeammateNumber` int(11) DEFAULT NULL,
